...
def find_top_assets():
    ...
    # Using a min-heap to keep track of the top 200 largest values.
    top_heap = []
    limit = 200
    ...
    for file_idx, filepath in enumerate(csv_files):
        print(f"Pass 1: Scanning {os.path.basename(filepath)}...")
        ...
        with open(filepath, "r", encoding="utf-8-sig", errors="ignore") as f:
            ...
            for row_idx, row in enumerate(reader):
                ...
                # To guarantee a stable sort in heap when amounts are equal, we include row_idx
    ...
    # Get the unique owner names of these top 200 assets
    ...
    # Write report data to a JSON file for backup/audit
    report_json_path = "scratch/top_assets_report.json"
...
def generate_markdown_report(report_data):
    report_path = "scratch/california_top_assets_report.md"
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("# California Top 200 Unclaimed Assets & Bundled Portfolio Report\n\n")
        ...
        f.write("## Top 200 Owners & Value Summary\n\n")
        ...
        f.write("Below is the detail of all properties associated with each of the top 50 owners in this dataset.\n\n")
    ...
    print(f"JSON backup report generated successfully at: scratch/top_assets_report.json")
